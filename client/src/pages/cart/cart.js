...
function Cart() {
    ...
    return (
        <div className="App2">
            ...
            <div style={{ border: '4px solid black', width: '1300px', marginLeft: '140px', marginBottom: '168px', marginTop: '100px'}}>
                ...
                <div key={item.id}>
                    <div key={item.id}>
                        <Table style={{width: '900px', marginLeft: '180px'}}>
                            <thead>
                                <tr>
                                    <th style={{backgroundColor: '#6298A4', color: '#0C4654', textAlign: "left"}}>
